...
public class LexiconTrieTest {
    ...
    public void testBadNonexistentFile() throws Exception {
        new LexiconTrie("NonExistent.dat");
    }

    // Some tests to make sure that LexiconTrie functions properly after being loaded
    @Test
    public void testValidWords() throws Exception {
        LexiconTrie l = new LexiconTrie(lex);
